...
<form class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                ...
                @foreach($columnsOptions as $columnsOptionKey => $columnsOptionValue)
                    ...
                    @if($columnsOptionValue['id'] == $article->column_id) selected @endif
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                ...
                @foreach($modelsOptions as $modelsOptionKey => $modelsOptionValue)
                    ...
                    @if($modelsOptionKey == $article->model_id) selected @endif
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <textarea class="layui-textarea" name="description">{{$article->description}}</textarea>
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <img src="/storage/{{$article->thumb}}" alt="{{__('articles.thumb')}}" class="image" id="imageImage">
                <button type="button" class="layui-btn" id="image">
                    <i class="layui-icon">&#xe67c;</i>上传图片
                </button>
                <input type="hidden" name="thumb" id="imageHidden" value="{{$article->thumb}}" />
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                @php
                    $attributesCheckeds = explode('|',$article->attributes)
                @endphp
                <div class="layui-input-block">
                    ...
                    @if(in_array($attributesOptionKey,$attributesCheckeds)) checked @endif
            ...
            @foreach($additionalFields as $additionalFieldsKey => $additionalFieldsValue)
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" id="L_email" name="additional_fields[{{$additionalFieldsValue->en_name}}]"
                                value="{{$additionalModel[$additionalFieldsValue->en_name]}}"
                            autocomplete="off" class="layui-input">
                        </div>
                    </div>
                ...
                @case(App\Models\Field::TYPE_RADIO)
                    <div class="layui-form-item">
                        ...
                        @foreach(explode('|',$additionalFieldsValue->values) as $radioValuesKey => $radioValuesValue)
                            ...
                            @if($radioValuesKey == $additionalModel[$additionalFieldsValue->en_name]) checked @endif
                ...
                @case(App\Models\Field::TYPE_CHECKBOX)
                    <div class="layui-form-item">
                        ...
                        @php
                            $checkboxValues = explode('|',$additionalFieldsValue->values);
                            $checkedValues = explode('|',$additionalModel[$additionalFieldsValue->en_name]);
                        @endphp
                        <div class="layui-input-block">
                        @foreach($checkboxValues as $checkboxValuesKey => $checkboxValuesValue)
                            <input type="checkbox" name="additional_fields[{{$additionalFieldsValue->en_name}}][{{$checkboxValuesKey}}]" 
                            @if(in_array($checkboxValuesKey,$checkedValues)) checked @endif
                                title="{{$checkboxValuesValue}}">
                        @endforeach
                        </div>
                        @php
                            unset($checkedValues);
                            unset($checkboxValues);
                        @endphp
                    </div>
                ...
                @case(App\Models\Field::TYPE_TEXT)
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            class="layui-textarea">{{$additionalModel[$additionalFieldsValue->en_name]}}</textarea>
                        </div>
                    </div>
                ...
                @case(App\Models\Field::TYPE_FILE)
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <img src="/storage/{{$additionalModel[$additionalFieldsValue->en_name]}}" alt="{{$additionalFieldsValue->zh_name}}" 
                            ...
                            <input type="hidden" name="additional_fields[{{$additionalFieldsValue->en_name}}]" 
                                id="{{$additionalFieldsValue->en_name}}_imageHidden" 
                                value="{{$additionalModel[$additionalFieldsValue->en_name]}}" />
                ...
                @case(App\Models\Field::TYPE_INT)
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            class="layui-input" value="{{$additionalModel[$additionalFieldsValue->en_name]}}"></input>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            @foreach(explode('|',$additionalFieldsValue->values) as $selectValuesKey => $selectValuesValue)
                                <option value="{{$selectValuesKey}}" 
                                @if($additionalModel[$additionalFieldsValue->en_name] == $selectValuesKey) selected @endif
                                >{{$selectValuesValue}}</option>
                            @endforeach
                            </select>
                        </div>
                    </div>
                ...
                @case(App\Models\Field::TYPE_EDITOR)
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <!-- 编辑器容器 -->
                            <script id="{{$additionalFieldsValue->en_name}}_container"
                             name="additional_fields[{{$additionalFieldsValue->en_name}}]" 
                             type="text/plain">{!! $additionalModel[$additionalFieldsValue->en_name] !!}</script>
                        </div>
                    </div>
...
layui.use(['form','layer'], function(){
    ...
    //表单提交
    admin.item_update(form,"{{route('admin.articles.update',[
        'article'=>$article->id
    ])}}")

...
<form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    @foreach($modelOptions as $modelOptionKey => $modelOptionValue)
                        <option value="{{$modelOptionKey}}" @if($item->model_id == $modelOptionKey) selected @endif>{{$modelOptionValue}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    @foreach($typeOptions as $typeOptionKey => $typeOptionValue)
                        <option value="{{$typeOptionKey}}" @if($item->type == $typeOptionKey) selected @endif>{{$typeOptionValue}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="values" id="seo_description" class="layui-textarea">{{$item->values}}</textarea>
                </div>
            </div>
...
layui.use(['form','layer'], function(){
    ...
    //表单提交
    admin.item_update(form,"{{route('admin.fields.update',$item->id)}}")

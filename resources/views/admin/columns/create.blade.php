        ...
        <form class="layui-tab-content layui-form">
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="parent_id" id="parent_id">
                            ...
                            <option value="{{$columnValue['id']}}">{{$columnValue['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        @foreach($modelsOptions as $modelsOptionKey => $modelsOptionValue)
                            <option value="{{$modelsOptionKey}}" @if($loop->first) selected @endif >{{$modelsOptionValue}}</option>
                        @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <img src="" alt="{{__('columns.image')}}" class="image" id="imageImage">
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="seo_description" id="seo_description" class="layui-textarea"></textarea>
                    </div>
                </div>
...
layui.use(['form','layer'], function(){
    ...
    //表单提交
    admin.item_create(form,"{{route('admin.columns.store')}}")

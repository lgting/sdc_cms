    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_username" name="name" value="{{$item->name}}" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_username" name="nickname" required="" value="{{$item->nickname}}" lay-verify="nikename"
                autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            @foreach($rolesOptions as $rolesOptionKey => $rolesOptionValue)
                ...
                @if(in_array($rolesOptionValue,$userRoles)) checked @endif
        ...
        <div class="layui-form-item">
            ...
            @foreach($permissionsOptions as $permissionsOptionKey => $permissionsOptionValue)
                ...
                @if(in_array($permissionsOptionValue,$userPermissions)) checked @endif
...
<script>
    layui.use(['form','layer'], function(){
        ...
        //监听提交
        admin.item_update(form,"{{route('admin.users.update',$item->id)}}")
